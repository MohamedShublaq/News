          ...
          <table class="table table-hover text-nowrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="{{ route('articles1restore' , ['id'=>$article->id , 'authid'=>$article->author_id]) }}" type="button" class="btn btn-success">Restore</a>
                            <a href="{{ route('articles1delete' , ['id'=>$article->id , 'authid'=>$article->author_id]) }}" type="button" class="btn btn-danger">Permanent Deletion</a>
                        </div>
                    </td>
                </tr>
                @endforeach
